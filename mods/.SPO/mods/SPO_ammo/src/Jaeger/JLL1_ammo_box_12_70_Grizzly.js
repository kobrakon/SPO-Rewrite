class JLL1_ammo_box_12_70_Grizzly
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_12_70_Grizzly";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_12_70_Grizzly"; // unique item id, used in tarkov
        ...
        const itemLongName = "12/70 Grizzly 40 slug pack (40 pcs)";
        const itemShortName = "Grizzly";
        const itemDescription = "A paper package of 12/70 Grizzly 40 slugs.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_12_70_Grizzly",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_12_70_Grizzly = JLL1_ammo_box_12_70_Grizzly;
