class JLL1_ammo_box_545x39_FMJ
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_545x39_FMJ";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_545x39_FMJ"; // unique item id, used in tarkov
        ...
        const itemTraderCurrency = "544fb62a4bdc2dfb738b4568"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_545x39_FMJ",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_545x39_FMJ = JLL1_ammo_box_545x39_FMJ;
