class JLL1_ammo_box_20_70_Poleva_3
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_20_70_Poleva_3";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_20_70_Poleva_3"; // unique item id, used in tarkov
        ...
        const itemLongName = "20x70mm 'Poleva-3' Slug pack (40 pcs)";
        const itemShortName = "Poleva-3";
        const itemDescription = "A paper package of 20x70mm 'Poleva-3' Slug 40 slugs.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_20_70_Poleva_3",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_20_70_Poleva_3 = JLL1_ammo_box_20_70_Poleva_3;
