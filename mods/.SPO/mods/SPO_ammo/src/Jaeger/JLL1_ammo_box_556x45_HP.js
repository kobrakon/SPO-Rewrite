class JLL1_ammo_box_556x45_HP
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_556x45_HP";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_556x45_HP"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.56x45mm HP ammo pack (120 pcs)";
        const itemShortName = "HP";
        const itemDescription = "A paper package of 5.56x45mm HP cartridges, 120 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_556x45_HP",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_556x45_HP = JLL1_ammo_box_556x45_HP;
