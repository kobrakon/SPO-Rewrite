class JLL4_ammo_box_12_70_RIP
{
    constructor()
    {
        this.modname = "JLL4_ammo_box_12_70_RIP";
    ...
    load()
    {
        const itemId = "JLL4_ammo_box_12_70_RIP"; // unique item id, used in tarkov
        ...
        const itemLongName = "12x70mm Shell RIP ammo pack (40 pcs)";
        const itemShortName = "RIP";
        const itemDescription = "A paper package of 12x70mm Shell RIP ammo pack. 40 Cartridges.";
        ...
        const itemTraderCurrency = "590c5d4b86f774784e1b9c45"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL4_ammo_box_12_70_RIP",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL4_ammo_box_12_70_RIP = JLL4_ammo_box_12_70_RIP;
