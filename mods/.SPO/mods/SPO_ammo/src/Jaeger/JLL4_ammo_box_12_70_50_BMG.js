class JLL4_ammo_box_12_70_50_BMG
{
    constructor()
    {
        this.modname = "JLL4_ammo_box_12_70_50_BMG";
    ...
    load()
    {
        const itemId = "JLL4_ammo_box_12_70_50_BMG"; // unique item id, used in tarkov
        ...
        const itemLongName = "12x70mm Shell with .50 BMG pack (40 pcs)";
        const itemShortName = ".50 BMG";
        const itemDescription = "A paper package of 12x70mm Shell with .50 BMG pack. 40 Cartridges.";
        ...
        const itemTraderCurrency = "5e2aef7986f7746d3f3c33f5"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL4_ammo_box_12_70_50_BMG",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL4_ammo_box_12_70_50_BMG = JLL4_ammo_box_12_70_50_BMG;
