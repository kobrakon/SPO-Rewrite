class JLL2_ammo_box_12_70_FTX
{
    constructor()
    {
        this.modname = "JLL2_ammo_box_12_70_FTX";
    ...
    load()
    {
        const itemId = "JLL2_ammo_box_12_70_FTX"; // unique item id, used in tarkov
        ...
        const itemLongName = "12/70 FTX Custom Lite Slug pack (40 pcs)";
        const itemShortName = "FTX";
        const itemDescription = "A paper package of 12/70 FTX Custom Lite Slug pack. 40 Cartridges.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL2_ammo_box_12_70_FTX",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL2_ammo_box_12_70_FTX = JLL2_ammo_box_12_70_FTX;
