class JLL1_ammo_box_762x39_HP
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_762x39_HP";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_762x39_HP"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x39mm HP ammo pack (120 pcs)";
        const itemShortName = "HP";
        const itemDescription = "A paper package of 7.62x39mm HP cartridges, 120 pieces.";
        ...
        const itemTraderCurrency = "5e2af2bc86f7746d3f3c33fc"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_762x39_HP",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_762x39_HP = JLL1_ammo_box_762x39_HP;
