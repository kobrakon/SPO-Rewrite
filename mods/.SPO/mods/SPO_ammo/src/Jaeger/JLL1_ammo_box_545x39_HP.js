class JLL1_ammo_box_545x39_HP
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_545x39_HP";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_545x39_HP"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.45x39mm FMJ ammo pack (120 pcs)";
        const itemShortName = "HP";
        const itemDescription = "A paper package of 5.45x39mm FMJ cartridges, 120 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_545x39_HP",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_545x39_HP = JLL1_ammo_box_545x39_HP;
