class JLL1_ammo_box_12_70_Roleca_3
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_12_70_Roleca_3";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_12_70_Roleca_3"; // unique item id, used in tarkov
        ...
        const itemLongName = "12/70 Poleca-3 slug pack (40 pcs)";
        const itemShortName = "Grizzly";
        const itemDescription = "A paper package of Poleca-3 slugs. 40 Cartridges.";
        ...
        const itemTraderCurrency = "590c2c9c86f774245b1f03f2"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_12_70_Roleca_3",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_12_70_Roleca_3 = JLL1_ammo_box_12_70_Roleca_3;
