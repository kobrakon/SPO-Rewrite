class JLL1_ammo_box_12_70_Ex
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_12_70_Ex";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_12_70_Ex"; // unique item id, used in tarkov
        ...
        const itemLongName = "12/70 6.5mm Express buckshot pack (40 pcs)";
        const itemShortName = "Express";
        const itemDescription = "A paper package of 12/70 6.5mm Express buckshot, 40 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_12_70_Ex",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_12_70_Ex = JLL1_ammo_box_12_70_Ex;
