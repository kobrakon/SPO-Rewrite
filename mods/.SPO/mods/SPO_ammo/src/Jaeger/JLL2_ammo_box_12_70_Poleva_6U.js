class JLL2_ammo_box_12_70_Poleva_6U
{
    constructor()
    {
        this.modname = "JLL2_ammo_box_12_70_Poleva_6U";
    ...
    load()
    {
        const itemId = "JLL2_ammo_box_12_70_Poleva_6U"; // unique item id, used in tarkov
        ...
        const itemLongName = "12/70 Poleva-6U Slug pack (40 pcs)";
        const itemShortName = "P-6U";
        const itemDescription = "A paper package of 12/70 Poleva-6U Slug pack. 40 Cartridges.";
        ...
        const itemTraderCurrency = "57514643245977207f2c2d09"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL2_ammo_box_12_70_Poleva_6U",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL2_ammo_box_12_70_Poleva_6U = JLL2_ammo_box_12_70_Poleva_6U;
