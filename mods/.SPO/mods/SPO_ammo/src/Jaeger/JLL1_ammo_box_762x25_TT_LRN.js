class JLL1_ammo_box_762x25_TT_LRN
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_762x25_TT_LRN";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_762x25_TT_LRN"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x25mm TT LRN ammo pack (180 pcs)";
        const itemShortName = "LRN";
        const itemDescription = "A paper package of 7.62x25mm TT LRN cartridges, 180 pieces.";
        ...
        const itemTraderCurrency = "5c13cef886f774072e618e82"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_762x25_TT_LRN",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_762x25_TT_LRN = JLL1_ammo_box_762x25_TT_LRN;
