class JLL1_ammo_box_366_TKM_EKO
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_366_TKM_EKO";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_366_TKM_EKO"; // unique item id, used in tarkov
        ...
        const itemLongName = ".366 TKM EKO ammo pack (120 pcs)";
        const itemShortName = "EKO";
        const itemDescription = "A paper package of .366 TKM EKO, 120 pieces.";
        ...
        const itemTraderCurrency = "57513f9324597720a7128161"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_366_TKM_EKO",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_366_TKM_EKO = JLL1_ammo_box_366_TKM_EKO;
