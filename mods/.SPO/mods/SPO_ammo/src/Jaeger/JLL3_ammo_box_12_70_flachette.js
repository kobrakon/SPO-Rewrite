class JLL3_ammo_box_12_70_flachette
{
    constructor()
    {
        this.modname = "JLL3_ammo_box_12_70_flachette";
    ...
    load()
    {
        const itemId = "JLL3_ammo_box_12_70_flachette"; // unique item id, used in tarkov
        ...
        const itemLongName = "12x70mm Flechette pack (40 pcs)";
        const itemShortName = "Flachet";
        const itemDescription = "A paper package of 12x70mm Flechette pack. 40 Cartridges.";
        ...
        const itemTraderCurrency = "57347d5f245977448b40fa81"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL3_ammo_box_12_70_flachette",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL3_ammo_box_12_70_flachette = JLL3_ammo_box_12_70_flachette;
