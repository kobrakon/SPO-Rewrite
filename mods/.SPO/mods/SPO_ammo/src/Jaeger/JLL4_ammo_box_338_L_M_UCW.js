class JLL4_ammo_box_338_L_M_UCW
{
    constructor()
    {
        this.modname = "JLL4_ammo_box_338_L_M_UCW";
    ...
    load()
    {
        const itemId = "JLL4_ammo_box_338_L_M_UCW"; // unique item id, used in tarkov
        ...
        const itemLongName = ".338 Lapua Magnum UCW ammo pack (80 pcs)";
        const itemShortName = "UCW";
        const itemDescription = "A paper package of .338 Lapua Magnum UCW, 80 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL4_ammo_box_338_L_M_UCW",
                  "_max_count": 80,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL4_ammo_box_338_L_M_UCW = JLL4_ammo_box_338_L_M_UCW;
