class JLL2_ammo_box_366_TKM_Geksa
{
    constructor()
    {
        this.modname = "JLL2_ammo_box_366_TKM_Geksa";
    ...
    load()
    {
        const itemId = "JLL2_ammo_box_366_TKM_Geksa"; // unique item id, used in tarkov
        ...
        const itemTraderCurrency = "57347d9c245977448b40fa85"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL2_ammo_box_366_TKM_Geksa",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL2_ammo_box_366_TKM_Geksa = JLL2_ammo_box_366_TKM_Geksa;
