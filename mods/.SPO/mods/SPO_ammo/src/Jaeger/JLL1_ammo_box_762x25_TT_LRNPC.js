class JLL1_ammo_box_762x25_TT_LRNPC
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_762x25_TT_LRNPC";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_762x25_TT_LRNPC"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x25mm TT LRNPC ammo pack (180 pcs)";
        const itemShortName = "LRNPC";
        const itemDescription = "A paper package of 7.62x25mm TT LRNPC cartridges, 180 pieces.";
        ...
        const itemTraderCurrency = "5c13cd2486f774072c757944"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_762x25_TT_LRNPC",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_762x25_TT_LRNPC = JLL1_ammo_box_762x25_TT_LRNPC;
