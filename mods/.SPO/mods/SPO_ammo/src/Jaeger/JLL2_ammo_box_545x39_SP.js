class JLL2_ammo_box_545x39_SP
{
    constructor()
    {
        this.modname = "JLL2_ammo_box_545x39_SP";
    ...
    load()
    {
        const itemId = "JLL2_ammo_box_545x39_SP"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.45x39mm SP ammo pack (120 pcs)";
        const itemShortName = "SP";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL2_ammo_box_545x39_SP",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL2_ammo_box_545x39_SP = JLL2_ammo_box_545x39_SP;
