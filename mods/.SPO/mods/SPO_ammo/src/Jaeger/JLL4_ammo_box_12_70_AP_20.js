class JLL4_ammo_box_12_70_AP_20
{
    constructor()
    {
        this.modname = "JLL4_ammo_box_12_70_AP_20";
    ...
    load()
    {
        const itemId = "JLL4_ammo_box_12_70_AP_20"; // unique item id, used in tarkov
        ...
        const itemLongName = "12x70 AP-20 Slug pack (40 pcs)";
        const itemShortName = "AP-20";
        const itemDescription = "A paper package of 12x70 AP-20 Slug pack. 40 Cartridges.";
        ...
        const itemTraderCurrency = "5b43575a86f77424f443fe62"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL4_ammo_box_12_70_AP_20",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL4_ammo_box_12_70_AP_20 = JLL4_ammo_box_12_70_AP_20;
