class JLL4_ammo_box_12_70_HP_SF
{
    constructor()
    {
        this.modname = "JLL4_ammo_box_12_70_HP_SF";
    ...
    load()
    {
        const itemId = "JLL4_ammo_box_12_70_HP_SF"; // unique item id, used in tarkov
        ...
        const itemLongName = "12x70mm HP Slug 'SFormance' with .50 BMG pack (40 pcs)";
        const itemShortName = "HP SF";
        const itemDescription = "A paper package of 12x70mm HP Slug 'SFormance' with .50 BMG pack. 40 Cartridges.";
        ...
        const itemTraderCurrency = "5448fee04bdc2dbc018b4567"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL4_ammo_box_12_70_HP_SF",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL4_ammo_box_12_70_HP_SF = JLL4_ammo_box_12_70_HP_SF;
