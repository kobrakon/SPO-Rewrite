class JLL2_ammo_box_12_70_Magnum
{
    constructor()
    {
        this.modname = "JLL2_ammo_box_12_70_Magnum";
    ...
    load()
    {
        const itemId = "JLL2_ammo_box_12_70_Magnum"; // unique item id, used in tarkov
        ...
        const itemLongName = "12/70 Magnum buckshot pack (40 pcs)";
        const itemShortName = "Magnum";
        const itemDescription = "A paper package of 12/70 Magnum buckshot. 40 Cartridges.";
        ...
        const itemTraderCurrency = "590a3d9c86f774385926e510"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL2_ammo_box_12_70_Magnum",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL2_ammo_box_12_70_Magnum = JLL2_ammo_box_12_70_Magnum;
