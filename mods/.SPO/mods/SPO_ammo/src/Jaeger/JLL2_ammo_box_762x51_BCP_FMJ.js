class JLL2_ammo_box_762x51_BCP_FMJ
{
    constructor()
    {
        this.modname = "JLL2_ammo_box_762x51_BCP_FMJ";
    ...
    load()
    {
        const itemId = "JLL2_ammo_box_762x51_BCP_FMJ"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x51 BCP FMJ ammo pack (80 pcs)";
        const itemShortName = "BCP FMJ";
        const itemDescription = "A paper package of 7.62x39mm BCP FMJ cartridges, 80 pieces.";
        ...
        const itemTraderCurrency = "59e3577886f774176a362503"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL2_ammo_box_762x51_BCP_FMJ",
                  "_max_count": 80,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL2_ammo_box_762x51_BCP_FMJ = JLL2_ammo_box_762x51_BCP_FMJ;
