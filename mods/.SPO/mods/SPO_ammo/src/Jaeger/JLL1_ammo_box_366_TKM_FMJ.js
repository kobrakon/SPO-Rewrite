class JLL1_ammo_box_366_TKM_FMJ
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_366_TKM_FMJ";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_366_TKM_FMJ"; // unique item id, used in tarkov
        ...
        const itemTraderCurrency = "57513fcc24597720a31c09a6"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_366_TKM_FMJ",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_366_TKM_FMJ = JLL1_ammo_box_366_TKM_FMJ;
