class JLL1_ammo_box_12_70_7
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_12_70_7";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_12_70_7"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.45x39mm SP ammo pack (40 pcs)";
        const itemShortName = "SP";
        const itemDescription = "A paper package of 5.45x39mm FMJ cartridges, 40 pieces.";
...
module.exports.JLL1_ammo_box_12_70_7 = JLL1_ammo_box_12_70_7;
