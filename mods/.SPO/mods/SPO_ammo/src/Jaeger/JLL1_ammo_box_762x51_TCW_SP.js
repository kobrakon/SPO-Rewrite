class JLL1_ammo_box_762x51_TCW_SP
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_762x51_TCW_SP";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_762x51_TCW_SP"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x51 TCW SP ammo pack (80 pcs)";
        const itemShortName = "TCW SP";
        const itemDescription = "A paper package of 7.62x39mm HP cartridges, 80 pieces.";
        ...
        const itemTraderCurrency = "590a391c86f774385a33c404"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_762x51_TCW_SP",
                  "_max_count": 80,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_762x51_TCW_SP = JLL1_ammo_box_762x51_TCW_SP;
