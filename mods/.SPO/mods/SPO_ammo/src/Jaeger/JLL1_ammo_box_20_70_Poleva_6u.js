class JLL1_ammo_box_20_70_Poleva_6u
{
    constructor()
    {
        this.modname = "JLL1_ammo_box_20_70_Poleva_6u";
    ...
    load()
    {
        const itemId = "JLL1_ammo_box_20_70_Poleva_6u"; // unique item id, used in tarkov
        ...
        const itemLongName = "20x70mm 'Poleva-6u' Slug pack (40 pcs)";
        const itemShortName = "Poleva-6u";
        const itemDescription = "A paper package of 20x70mm 'Poleva-6u' Slug 40 slugs.";
        ...
        const itemTraderCurrency = "57513f07245977207e26a311"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL1_ammo_box_20_70_Poleva_6u",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL1_ammo_box_20_70_Poleva_6u = JLL1_ammo_box_20_70_Poleva_6u;
