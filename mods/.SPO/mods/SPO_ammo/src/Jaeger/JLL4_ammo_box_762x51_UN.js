class JLL4_ammo_box_762x51_UN
{
    constructor()
    {
        this.modname = "JLL4_ammo_box_762x51_UN";
    ...
    load()
    {
        const itemId = "JLL4_ammo_box_762x51_UN"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x51 Ultra Nosler ammo pack (80 pcs)";
        const itemShortName = "UN";
        const itemDescription = "A paper package of 7.62x39mm Ultra Nosler cartridges, 80 pieces.";
        ...
        const itemTraderCurrency = "590c639286f774151567fa95"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL4_ammo_box_762x51_UN",
                  "_max_count": 80,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL4_ammo_box_762x51_UN = JLL4_ammo_box_762x51_UN;
