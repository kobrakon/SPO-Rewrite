class JLL3_ammo_box_12_70_Dual
{
    constructor()
    {
        this.modname = "JLL3_ammo_box_12_70_Dual";
    ...
    load()
    {
        const itemId = "JLL3_ammo_box_12_70_Dual"; // unique item id, used in tarkov
        ...
        const itemLongName = "12x70 Dual Sabot Slug pack (40 pcs)";
        const itemShortName = "DSS";
        const itemDescription = "A paper package of 12x70 Dual Sabot Slug pack. 40 Cartridges.";
        ...
        const itemTraderCurrency = "5c0fa877d174af02a012e1cf"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL3_ammo_box_12_70_Dual",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL3_ammo_box_12_70_Dual = JLL3_ammo_box_12_70_Dual;
