class JLL3_ammo_box_20_70_Devastator
{
    constructor()
    {
        this.modname = "JLL3_ammo_box_20_70_Devastator";
    ...
    load()
    {
        const itemId = "JLL3_ammo_box_20_70_Devastator"; // unique item id, used in tarkov
        ...
        const itemLongName = "20x70mm Devastator Slug (40 pcs)";
        const itemShortName = "Devastator";
        const itemDescription = "A paper package of 20x70mm Devastator Slug pack. 40 Cartridges.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "JLL3_ammo_box_20_70_Devastator",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.JLL3_ammo_box_20_70_Devastator = JLL3_ammo_box_20_70_Devastator;
