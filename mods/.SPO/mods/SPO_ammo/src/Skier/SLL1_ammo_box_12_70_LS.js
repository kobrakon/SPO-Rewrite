class SLL1_ammo_box_12_70_LS
{
    constructor()
    {
        this.modname = "SLL1_ammo_box_12_70_LS";
    ...
    load()
    {
        const itemId = "SLL1_ammo_box_12_70_LS"; // unique item id, used in tarkov
        ...
        const itemLongName = "12/70 Lead Slug pack (40 pcs)";
        const itemShortName = "Express";
        const itemDescription = "A paper package of 12/70 Lead Slug, 40 pieces.";

        // offer
        const itemTrader = "58330581ace78e27b8b10cee"; // P 54cb50c76803fa8b248b4571 /  S 58330581ace78e27b8b10cee / M 5a7c2eca46aef81a7ca2145d / J 5c0647fdd443bc2504c2d371 / PK 5935c25fb3acc3127c3d8cd9
        const itemTraderPrice = 1;
        const itemTraderCurrency = "57347d692459774491567cf1"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  "_name": "cartridges",
                  "_id": "57372bd3245977670b711113",
                  "_parent": "SLL1_ammo_box_12_70_LS",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.SLL1_ammo_box_12_70_LS = SLL1_ammo_box_12_70_LS;
