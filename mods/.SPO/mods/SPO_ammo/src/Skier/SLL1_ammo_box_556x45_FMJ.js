class SLL1_ammo_box_556x45_FMJ
{
    constructor()
    {
        this.modname = "SLL1_ammo_box_556x45_FMJ";
    ...
    load()
    {
        const itemId = "SLL1_ammo_box_556x45_FMJ"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.56x45mm FMJ ammo pack (120 pcs)";
        const itemShortName = "FMJ";
        const itemDescription = "A paper package of 5.56x45mm FMJFMJ cartridges, 120 pieces.";
        ...
        const itemTraderPrice = 3;
        const itemTraderCurrency = "5448ff904bdc2d6f028b456e"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "SLL1_ammo_box_556x45_FMJ",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.SLL1_ammo_box_556x45_FMJ = SLL1_ammo_box_556x45_FMJ;
