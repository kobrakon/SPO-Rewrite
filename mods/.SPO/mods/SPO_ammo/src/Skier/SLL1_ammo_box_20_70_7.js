class SLL1_ammo_box_20_70_7
{
    constructor()
    {
        this.modname = "SLL1_ammo_box_20_70_7";
    ...
    load()
    {
        const itemId = "SLL1_ammo_box_20_70_7"; // unique item id, used in tarkov
        ...
        const itemLongName = "20/70 7mm buckshot pack (40 pcs)";
        const itemShortName = "7";
        const itemDescription = "A paper package of 20/70 7mm buckshot, 40 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "SLL1_ammo_box_20_70_7",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
                        "Filter": [
                          "58820d1224544753c90aeb13"
                        ]
                      }
                    ]
                  },
...
module.exports.SLL1_ammo_box_20_70_7 = SLL1_ammo_box_20_70_7;
