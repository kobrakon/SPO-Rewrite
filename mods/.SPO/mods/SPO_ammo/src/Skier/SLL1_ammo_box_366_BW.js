class SLL1_ammo_box_366_BW
{
    constructor()
    {
        this.modname = "SLL1_ammo_box_366_BW";
    ...
    load()
    {
        const itemId = "SLL1_ammo_box_366_BW"; // unique item id, used in tarkov
        ...
        const itemLongName = ".300 Blackout Whisper ammo pack (120 pcs)";
        const itemShortName = "BW";
        const itemDescription = "A paper package of .300 The Whisper cartridge, 120 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  "_name": "cartridges",
                  "_id": "57372bd3242227670b7cd243",
                  "_parent": "SLL1_ammo_box_366_BW",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.SLL1_ammo_box_366_BW = SLL1_ammo_box_366_BW;
