class SLL1_ammo_box_12_70_7
{
    constructor()
    {
        this.modname = "SLL1_ammo_box_12_70_7";
    ...
    load()
    {
        const itemId = "SLL1_ammo_box_12_70_7"; // unique item id, used in tarkov
        ...
        const itemLongName = "12/70 7mm buckshot pack (40 pcs)";
        const itemShortName = "7";
        const itemDescription = "A paper package 12/70 7mm buckshot pack, 40 pieces.";
        ...
        const itemTraderCurrency = "5751487e245977207e26a315"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  "_name": "cartridges",
                  "_id": "57372bd3245966670b7cd243",
                  "_parent": "SLL1_ammo_box_12_70_7",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.SLL1_ammo_box_12_70_7 = SLL1_ammo_box_12_70_7;
