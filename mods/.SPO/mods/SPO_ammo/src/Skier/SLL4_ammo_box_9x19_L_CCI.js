class SLL4_ammo_box_9x19_L_CCI
{
    constructor()
    {
        this.modname = "SLL4_ammo_box_9x19_L_CCI";
    ...
    load()
    {
        const itemId = "SLL4_ammo_box_9x19_L_CCI"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x19mm Luger CCI ammo pack (120 pcs)";
        const itemShortName = "CCI";
        const itemDescription = "A paper package of 9x19mm Luger CCI cartridges, 120 pieces.";
        ...
        const itemTraderCurrency = "573476f124597737e04bf328"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "SLL4_ammo_box_9x19_L_CCI",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.SLL4_ammo_box_9x19_L_CCI = SLL4_ammo_box_9x19_L_CCI;
