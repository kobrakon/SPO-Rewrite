class SLL3_ammo_box_300_B_FMJ
{
    constructor()
    {
        this.modname = "SLL3_ammo_box_300_B_FMJ";
    ...
    load()
    {
        const itemId = "SLL3_ammo_box_300_B_FMJ"; // unique item id, used in tarkov
        ...
        const itemLongName = ".300 Blackout BCP ammo pack (120 pcs)";
        const itemShortName = "BCP";
        const itemDescription = "A paper package of .300 Blackout BCP FMJ, 120 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "SLL3_ammo_box_300_B_FMJ",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.SLL3_ammo_box_300_B_FMJ = SLL3_ammo_box_300_B_FMJ;
