class SLL4_ammo_box_556x45M855A1
{
    constructor()
    {
        this.modname = "SLL4_ammo_box_556x45M855A1";
    ...
    load()
    {
        const itemId = "SLL4_ammo_box_556x45M855A1"; // unique item id, used in tarkov
        ...
        const itemTraderCurrency = "573476d324597737da2adc13"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "SLL4_ammo_box_556x45M855A1",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.SLL4_ammo_box_556x45M855A1 = SLL4_ammo_box_556x45M855A1;
