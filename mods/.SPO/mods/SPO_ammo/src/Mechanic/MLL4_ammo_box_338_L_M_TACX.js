class MLL4_ammo_box_338_L_M_TACX
{
    constructor()
    {
        this.modname = "MLL4_ammo_box_338_L_M_TACX";
    ...
    load()
    {
        const itemId = "MLL4_ammo_box_338_L_M_TACX"; // unique item id, used in tarkov
        ...
        const itemLongName = ".338 Lapua Magnum TAC-X ammo pack (40 pcs)";
        const itemShortName = "TAC-X";
        const itemDescription = "A paper package of .338 Lapua Magnum TAC-X, 40 pieces.";
        ...
        const itemTraderCurrency = "573477e124597737dd42e191"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "MLL4_ammo_box_338_L_M_TACX",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.MLL4_ammo_box_338_L_M_TACX = MLL4_ammo_box_338_L_M_TACX;
