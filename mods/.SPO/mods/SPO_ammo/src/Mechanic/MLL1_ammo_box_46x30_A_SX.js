class MLL1_ammo_box_46x30_A_SX
{
    constructor()
    {
        this.modname = "MLL1_ammo_box_46x30_A_SX";
    ...
    load()
    {
        const itemId = "MLL1_ammo_box_46x30_A_SX"; // unique item id, used in tarkov
        const itemClone = "5447ac644bdc2d6c208b4567"; // base item, make clone from this

        // handbook
        const itemCategory = "543be5cb4bdc2deb348b4568"; // https://docs.sp-tarkov.com/#resourceCapacitorss/items_stats.md -->> Weapon Parts & mod
        ...
        const itemLongName = "4.6x30mm Action SX ammo pack (180 pcs)";
        const itemShortName = "SX";
        const itemDescription = "A paper package of 4.6x30mm Action SX cartridges, 180 pieces.";

        // offer
        const itemTrader = "5a7c2eca46aef81a7ca2145d"; // P 54cb50c76803fa8b248b4571 /  S 58330581ace78e27b8b10cee / M 5a7c2eca46aef81a7ca2145d / J 5c0647fdd443bc2504c2d371 / PK 5935c25fb3acc3127c3d8cd9
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5c06782b86f77426df5407d2"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "MLL1_ammo_box_46x30_A_SX",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.MLL1_ammo_box_46x30_A_SX = MLL1_ammo_box_46x30_A_SX;
