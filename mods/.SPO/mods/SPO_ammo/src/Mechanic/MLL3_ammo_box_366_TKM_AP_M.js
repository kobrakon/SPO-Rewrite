class MLL3_ammo_box_366_TKM_AP_M
{
    constructor()
    {
        this.modname = "MLL3_ammo_box_366_TKM_AP_M";
    ...
    load()
    {
        const itemId = "MLL3_ammo_box_366_TKM_AP_M"; // unique item id, used in tarkov
        ...
        const itemLongName = ".366 TKM AP-M ammo pack (120 pcs)";
        const itemShortName = "AP-M";
        const itemDescription = "A paper package of .366 TKM AP-M, 120 pieces.";
        ...
        const itemTraderCurrency = "5d4042a986f7743185265463"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "MLL3_ammo_box_366_TKM_AP_M",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.MLL3_ammo_box_366_TKM_AP_M = MLL3_ammo_box_366_TKM_AP_M;
