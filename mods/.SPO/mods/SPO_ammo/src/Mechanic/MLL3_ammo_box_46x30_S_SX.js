class MLL3_ammo_box_46x30_S_SX
{
    constructor()
    {
        this.modname = "MLL3_ammo_box_46x30_S_SX";
    ...
    load()
    {
        const itemId = "MLL3_ammo_box_46x30_S_SX"; // unique item id, used in tarkov
        ...
        const itemLongName = "4.6x30mm Subsonic SX ammo pack (180 pcs)";
        const itemShortName = "SX";
        const itemDescription = "A paper package of 4.6x30mm Subsonic SX cartridges, 180 pieces.";
        ...
        const itemTraderCurrency = "57347baf24597738002c6178"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "MLL3_ammo_box_46x30_S_SX",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.MLL3_ammo_box_46x30_S_SX = MLL3_ammo_box_46x30_S_SX;
