class MLL4_ammo_box_45_ACP_RIP
{
    constructor()
    {
        this.modname = "MLL4_ammo_box_45_ACP_RIP";
    ...
    load()
    {
        const itemId = "MLL4_ammo_box_45_ACP_RIP"; // unique item id, used in tarkov
        ...
        const itemLongName = ".45 ACP RIP ammo pack (180 pcs)";
        const itemShortName = "RIP";
        const itemDescription = "A paper package of .45 ACP RIP cartridges, 180 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "MLL4_ammo_box_45_ACP_RIP",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.MLL4_ammo_box_45_ACP_RIP = MLL4_ammo_box_45_ACP_RIP;
