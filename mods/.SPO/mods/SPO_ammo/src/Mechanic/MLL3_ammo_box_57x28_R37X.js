class MLL3_ammo_box_57x28_R37X
{
    constructor()
    {
        this.modname = "MLL3_ammo_box_57x28_R37X";
    ...
    load()
    {
        const itemId = "MLL3_ammo_box_57x28_R37X"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.7x28mm R37.X ammo pack (180 pcs)";
        const itemShortName = "R37.X";
        const itemDescription = "A paper package of 5.7x28mm R37.X, 180 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "56742c324bdc2d150f8b456d"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "MLL3_ammo_box_57x28_R37X",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.MLL3_ammo_box_57x28_R37X = MLL3_ammo_box_57x28_R37X;
