class PLL3_ammo_box_762x39_BP
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_762x39_BP";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_762x39_BP"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x39mm BP ammo pack (120 pcs)";
        const itemShortName = "BP";
        const itemDescription = "A paper package of 7.62x39mm BP cartridges, 120 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5bc9c29cd4351e003562b8a3"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_762x39_BP",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_762x39_BP = PLL3_ammo_box_762x39_BP;
