class PLL2_ammo_box_762x25_TT_PT
{
    constructor()
    {
        this.modname = "PLL2_ammo_box_762x25_TT_PT";
    ...
    load()
    {
        const itemId = "PLL2_ammo_box_762x25_TT_PT"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x25mm TT PT ammo pack (180 pcs)";
        const itemShortName = "PT";
        const itemDescription = "A paper package of 7.62x25mm TT PT cartridges, 180 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "590c2b4386f77425357b6123"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL2_ammo_box_762x25_TT_PT",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL2_ammo_box_762x25_TT_PT = PLL2_ammo_box_762x25_TT_PT;
