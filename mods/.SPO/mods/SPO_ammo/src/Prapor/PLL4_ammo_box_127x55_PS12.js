class PLL4_ammo_box_127x55_PS12
{
    constructor()
    {
        this.modname = "PLL4_ammo_box_127x55_PS12";
    ...
    load()
    {
        const itemId = "PLL4_ammo_box_127x55_PS12"; // unique item id, used in tarkov
        ...
        const itemLongName = "12.7mm PS12x55mm ammo pack (60 pcs)";
        const itemShortName = "PS12";
        const itemDescription = "A paper package of 12.7mm PS12x55mm cartridges, 60 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "57347d8724597744596b4e76"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL4_ammo_box_127x55_PS12",
                  "_max_count": 60,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL4_ammo_box_127x55_PS12 = PLL4_ammo_box_127x55_PS12;
