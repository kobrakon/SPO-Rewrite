class PLL3_ammo_box_9x18_PM_Pst
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_9x18_PM_Pst";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_9x18_PM_Pst"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x18mm PM Pst ammo pack (180 pcs)";
        const itemShortName = "PT";
        const itemDescription = "A paper package of 9x18mm PM Pst cartridges, 180 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_9x18_PM_Pst",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_9x18_PM_Pst = PLL3_ammo_box_9x18_PM_Pst;
