class PLL3_ammo_box_9x39_SPP
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_9x39_SPP";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_9x39_SPP"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x39mm SPP ammo pack (60 pcs)";
        const itemShortName = "SPP";
        const itemDescription = "A paper package of 9x39mm SPP cartridges, 60 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_9x39_SPP",
                  "_max_count": 60,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_9x39_SPP = PLL3_ammo_box_9x39_SPP;
