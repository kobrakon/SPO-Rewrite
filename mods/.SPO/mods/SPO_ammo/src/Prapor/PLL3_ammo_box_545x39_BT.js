class PLL3_ammo_box_545x39_BT
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_545x39_BT";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_545x39_BT"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.45x39mm BT ammo pack (120 pcs)";
        const itemShortName = "BT";
        const itemDescription = "A paper package of 5.45x39mm BT cartridges, 120 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "60391afc25aff57af81f7085"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_545x39_BT",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_545x39_BT = PLL3_ammo_box_545x39_BT;
