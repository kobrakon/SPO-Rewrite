class PLL2_ammo_box_9x39_SP_5
{
    constructor()
    {
        this.modname = "PLL2_ammo_box_9x39_SP_5";
    ...
    load()
    {
        const itemId = "PLL2_ammo_box_9x39_SP_5"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x39mm SP-5 ammo pack (90 pcs)";
        const itemShortName = "P";
        const itemDescription = "A paper package of 9x39mm SP-5 cartridges, 90 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 4;
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  "_name": "cartridges",
                  "_id": "PLL2_ammo_box_9x39_SP_5",
                  "_parent": "PLL2_ammo_box_9x39_SP_5",
                  "_max_count": 90,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL2_ammo_box_9x39_SP_5 = PLL2_ammo_box_9x39_SP_5;
