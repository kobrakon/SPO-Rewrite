class PLL3_ammo_box_127x55_PS12A
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_127x55_PS12A";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_127x55_PS12A"; // unique item id, used in tarkov
        ...
        const itemLongName = "12.7x55mm PS12A ammo pack (60 pcs)";
        const itemShortName = "PS12A";
        const itemDescription = "A paper package of 12.7mm PS12Ax55 cartridges, 60 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "61bf7b6302b3924be92fa8c3"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_127x55_PS12A",
                  "_max_count": 60,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_127x55_PS12A = PLL3_ammo_box_127x55_PS12A;
