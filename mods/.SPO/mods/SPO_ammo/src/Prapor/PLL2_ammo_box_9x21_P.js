class PLL2_ammo_box_9x21_P
{
    constructor()
    {
        this.modname = "PLL2_ammo_box_9x21_P";
    ...
    load()
    {
        const itemId = "PLL2_ammo_box_9x21_P"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x21 P ammo pack (180 pcs)";
        const itemShortName = "P";
        const itemDescription = "A paper package of 9x21 P cartridges, 180 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "57347c77245977448d35f6e2"
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  "_name": "cartridges",
                  "_id": "PLL2_ammo_box_9x21_P",
                  "_parent": "PLL2_ammo_box_9x21_P",
                  "_max_count": 90,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL2_ammo_box_9x21_P = PLL2_ammo_box_9x21_P;
