class PLL3_ammo_box_23x75_Shrapne_25
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_23x75_Shrapne_25";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_23x75_Shrapne_25"; // unique item id, used in tarkov
        ...
        const itemLongName = "23x75 'Shrapnel-25' ammo pack (40 pcs)";
        const itemShortName = "Sh25";
        const itemDescription = "A paper package of 23x75 'Shrapnel-25' cartridges, 40 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5d1b385e86f774252167b98a"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_23x75_Shrapne_25",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_23x75_Shrapne_25 = PLL3_ammo_box_23x75_Shrapne_25;
