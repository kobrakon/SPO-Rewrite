class PLL2_ammo_box_762x25_TT_P
{
    constructor()
    {
        this.modname = "PLL2_ammo_box_762x25_TT_P";
    ...
    load()
    {
        const itemId = "PLL2_ammo_box_762x25_TT_P"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x25mm TT P ammo pack (180 pcs)";
        const itemShortName = "US";
        const itemDescription = "A paper package of 7.62x25mm TT P cartridges, 180 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL2_ammo_box_762x25_TT_P",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL2_ammo_box_762x25_TT_P = PLL2_ammo_box_762x25_TT_P;
