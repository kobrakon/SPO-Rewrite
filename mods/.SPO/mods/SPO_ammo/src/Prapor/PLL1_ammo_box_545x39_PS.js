class PLL1_ammo_box_545x39_PS
{
    constructor()
    {
        this.modname = "PLL1_ammo_box_545x39_PS";
    ...
    load()
    {
        const itemId = "PLL1_ammo_box_545x39_PS"; // unique item id, used in tarkov
        const itemClone = "57372bd3245977670b7cd243"; // base item, make clone from this

        // handbook
        const itemCategory = "543be5cb4bdc2deb348b4568"; // Strike Cigarettes
        ...
        const itemLongName = "5.45x39 PS ammo pack (120 pcs)";
        const itemShortName = "PS";
        const itemDescription = "A paper package of 5.45x39 PS cartridges, 120 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  "_name": "cartridges",
                  "_id": "PLL1_ammo_box_545x39_PS",
                  "_parent": "PLL1_ammo_box_545x39_PS",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL1_ammo_box_545x39_PS = PLL1_ammo_box_545x39_PS;
