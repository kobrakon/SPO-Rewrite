class PLL3_ammo_box_9x21_PE
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_9x21_PE";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_9x21_PE"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x21mm PE ammo pack (60 pcs)";
        const itemShortName = "PE";
        const itemDescription = "A paper package of 9x21mm PE cartridges, 60 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5af04b6486f774195a3ebb49"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
...
module.exports.PLL3_ammo_box_9x21_PE = PLL3_ammo_box_9x21_PE;
