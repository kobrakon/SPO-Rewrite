class PLL4_ammo_box_23x75_Barrikada
{
    constructor()
    {
        this.modname = "PLL4_ammo_box_23x75_Barrikada";
    ...
    load()
    {
        const itemId = "PLL4_ammo_box_23x75_Barrikada"; // unique item id, used in tarkov
        ...
        const itemLongName = "23x75mm 'Barrikada' ammo pack (40 pcs)";
        const itemShortName = "Barrik";
        const itemDescription = "A paper package of 23x75mm 'Barrikada' cartridges, 40 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "57505f6224597709a92585a9"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL4_ammo_box_23x75_Barrikada",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL4_ammo_box_23x75_Barrikada = PLL4_ammo_box_23x75_Barrikada;
