class PLL3_ammo_box_9x18_PMM_PstM
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_9x18_PMM_PstM";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_9x18_PMM_PstM"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x18mm PMM PstM ammo pack (180 pcs)";
        const itemShortName = "PstM";
        const itemDescription = "A paper package of 9x18mm PMM PstM cartridges, 180 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_9x18_PMM_PstM",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_9x18_PMM_PstM = PLL3_ammo_box_9x18_PMM_PstM;
