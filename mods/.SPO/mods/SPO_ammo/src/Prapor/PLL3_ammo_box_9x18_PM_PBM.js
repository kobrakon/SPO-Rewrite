class PLL3_ammo_box_9x18_PM_PBM
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_9x18_PM_PBM";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_9x18_PM_PBM"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x18mm PM PBM ammo pack (180 pcs)";
        const itemShortName = "PBM";
        const itemDescription = "A paper package of 9x18mm PM PBM cartridges, 180 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_9x18_PM_PBM",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_9x18_PM_PBM = PLL3_ammo_box_9x18_PM_PBM;
