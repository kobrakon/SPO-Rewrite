class PLL3_ammo_box_9x18_PM_SP7
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_9x18_PM_SP7";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_9x18_PM_SP7"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x18mm PM SP7 ammo pack (180 pcs)";
        const itemShortName = "SP7";
        const itemDescription = "A paper package of 9x18mm PM SP7 cartridges, 180 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_9x18_PM_SP7",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_9x18_PM_SP7 = PLL3_ammo_box_9x18_PM_SP7;
