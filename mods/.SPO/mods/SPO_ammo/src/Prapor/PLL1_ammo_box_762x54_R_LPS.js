class PLL1_ammo_box_762x54_R_LPS
{
    constructor()
    {
        this.modname = "PLL1_ammo_box_762x54_R_LPS";
    ...
    load()
    {
        const itemId = "PLL1_ammo_box_762x54_R_LPS"; // unique item id, used in tarkov
        ...
        // item
        const itemPrefabPath = "PLL1_ammo_box_762x54_R_LPS"; // Server/mods/this.modname/bundles/... CAB 2e33dcd51900e1153e9615eca8d9afa3 === f2ba5588e4d8c01fb4f96ad9b2fb64bb
        const itemLongName = "7.62x54 R LPS ammo pack (80 pcs)";
        const itemShortName = "LPS";
        const itemDescription = "A paper package of 7.62x54 R LPS cartridges, 80 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5d40407c86f774318526545a"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  "_name": "cartridges",
                  "_id": "762x54_R_LPS",
                  "_parent": "PLL1_ammo_box_762x54_R_LPS",
                  "_max_count": 80,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL1_ammo_box_762x54_R_LPS = PLL1_ammo_box_762x54_R_LPS;
