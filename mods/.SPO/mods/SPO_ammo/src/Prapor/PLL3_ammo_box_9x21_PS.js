class PLL3_ammo_box_9x21_PS
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_9x21_PS";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_9x21_PS"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x21mm PS ammo pack (60 pcs)";
        const itemShortName = "PS";
        const itemDescription = "A paper package of 9x21mm PS cartridges, 60 pieces.";
...
module.exports.PLL3_ammo_box_9x21_PS = PLL3_ammo_box_9x21_PS;
