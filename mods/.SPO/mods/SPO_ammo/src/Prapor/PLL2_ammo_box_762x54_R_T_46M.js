class PLL2_ammo_box_762x54_R_T_46M
{
    constructor()
    {
        this.modname = "PLL2_ammo_box_762x54_R_T_46M";
    ...
    load()
    {
        const itemId = "PLL2_ammo_box_762x54_R_T_46M"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x54mm R T-46M ammo pack (40 pcs)";
        const itemShortName = "T-45M1";
        const itemDescription = "A paper package of 7.62x39mm T-45M1 cartridges, 40 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "575146b724597720a27126d5"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL2_ammo_box_762x54_R_T_46M",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL2_ammo_box_762x54_R_T_46M = PLL2_ammo_box_762x54_R_T_46M;
