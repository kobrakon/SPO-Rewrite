class PLL4_ammo_box_762x54_R_BT
{
    constructor()
    {
        this.modname = "PLL4_ammo_box_762x54_R_BT";
    ...
    load()
    {
        const itemId = "PLL4_ammo_box_762x54_R_BT"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x54mm R BT ammo pack (40 pcs)";
        const itemShortName = "BT";
        const itemDescription = "A paper package of 7.62x39mm BT cartridges, 40 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5d1b317c86f7742523398392"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL4_ammo_box_762x54_R_BT",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL4_ammo_box_762x54_R_BT = PLL4_ammo_box_762x54_R_BT;
