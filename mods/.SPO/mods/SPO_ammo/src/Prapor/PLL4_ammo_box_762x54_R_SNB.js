class PLL4_ammo_box_762x54_R_SNB
{
    constructor()
    {
        this.modname = "PLL4_ammo_box_762x54_R_SNB";
    ...
    load()
    {
        const itemId = "PLL4_ammo_box_762x54_R_SNB"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x54mm R SNB ammo pack (40 pcs)";
        const itemShortName = "SNB";
        const itemDescription = "A paper package of 7.62x54mm R SNB cartridges, 40 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "619cbf476b8a1b37a54eebf8"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL4_ammo_box_762x54_R_SNB",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL4_ammo_box_762x54_R_SNB = PLL4_ammo_box_762x54_R_SNB;
