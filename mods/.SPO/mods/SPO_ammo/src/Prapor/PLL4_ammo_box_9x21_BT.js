class PLL4_ammo_box_9x21_BT
{
    constructor()
    {
        this.modname = "PLL4_ammo_box_9x21_BT";
    ...
    load()
    {
        const itemId = "PLL4_ammo_box_9x21_BT"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x21mm BT ammo pack (120 pcs)";
        const itemShortName = "BT";
        const itemDescription = "A paper package of 9x21mm BT cartridges, 120 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5bc9c049d4351e44f824d360"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
...
module.exports.PLL4_ammo_box_9x21_BT = PLL4_ammo_box_9x21_BT;
