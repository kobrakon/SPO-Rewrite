class PLL3_ammo_box_9x39_SP_6
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_9x39_SP_6";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_9x39_SP_6"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x39mm SP-6 ammo pack (60 pcs)";
        const itemShortName = "SP-6";
        const itemDescription = "A paper package of 9x39mm SP-6 cartridges, 60 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "5bf3e03b0db834001d2c4a9c"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_9x39_SP_6",
                  "_max_count": 60,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_9x39_SP_6 = PLL3_ammo_box_9x39_SP_6;
