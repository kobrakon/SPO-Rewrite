class PLL3_ammo_box_9x18_PM_SP8
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_9x18_PM_SP8";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_9x18_PM_SP8"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x18mm PM SP8 ammo pack (180 pcs)";
        const itemShortName = "SP8";
        const itemDescription = "A paper package of 9x18mm PM SP8 cartridges, 180 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "590c311186f77424d1667482"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_9x18_PM_SP8",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_9x18_PM_SP8 = PLL3_ammo_box_9x18_PM_SP8;
