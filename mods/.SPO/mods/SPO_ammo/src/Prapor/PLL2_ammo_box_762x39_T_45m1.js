class PLL2_ammo_box_762x39_T_45m1
{
    constructor()
    {
        this.modname = "PLL2_ammo_box_762x39_T_45m1";
    ...
    load()
    {
        const itemId = "PLL2_ammo_box_762x39_T_45m1"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x39mm T-45M1 ammo pack (120 pcs)";
        const itemShortName = "T-45M1";
        const itemDescription = "A paper package of 7.62x39mm T-45M1 cartridges, 120 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5d1b31ce86f7742523398394"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL2_ammo_box_762x39_T_45m1",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL2_ammo_box_762x39_T_45m1 = PLL2_ammo_box_762x39_T_45m1;
