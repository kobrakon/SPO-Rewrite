class PLL2_ammo_box_545x39_20_PP
{
    constructor()
    {
        this.modname = "PLL2_ammo_box_545x39_20_PP";
    ...
    load()
    {
        const itemId = "PLL2_ammo_box_545x39_20_PP"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.45x39mm PP ammo pack (180 pcs)";
        const itemShortName = "PP";
        const itemDescription = "A paper package of 5.45x39mm PP cartridges, 180 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL2_ammo_box_545x39_20_PP",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL2_ammo_box_545x39_20_PP = PLL2_ammo_box_545x39_20_PP;
