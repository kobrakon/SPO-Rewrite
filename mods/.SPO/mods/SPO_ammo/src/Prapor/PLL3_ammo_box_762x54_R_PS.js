class PLL3_ammo_box_762x54_R_PS
{
    constructor()
    {
        this.modname = "PLL3_ammo_box_762x54_R_PS";
    ...
    load()
    {
        const itemId = "PLL3_ammo_box_762x54_R_PS"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x54mm R PS ammo pack (40 pcs)";
        const itemShortName = "PS";
        const itemDescription = "A paper package of 7.62x39mm PS cartridges, 40 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL3_ammo_box_762x54_R_PS",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL3_ammo_box_762x54_R_PS = PLL3_ammo_box_762x54_R_PS;
