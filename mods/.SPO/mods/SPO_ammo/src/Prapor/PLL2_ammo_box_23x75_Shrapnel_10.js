class PLL2_ammo_box_23x75_Shrapnel_10
{
    constructor()
    {
        this.modname = "PLL2_ammo_box_23x75_Shrapnel_10";
    ...
    load()
    {
        const itemId = "PLL2_ammo_box_23x75_Shrapnel_10"; // unique item id, used in tarkov
        ...
        const itemLongName = "23x75mm Shrapnel 10 ammo pack (40 pcs)";
        const itemShortName = "Shr-10";
        const itemDescription = "A paper package of 23x75mm Shrapnel 10 shells, 40 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "590c31c586f774245e3141b2"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL2_ammo_box_23x75_Shrapnel_10",
                  "_max_count": 40,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL2_ammo_box_23x75_Shrapnel_10 = PLL2_ammo_box_23x75_Shrapnel_10;
