class PLL2_ammo_box_545x39_US
{
    constructor()
    {
        this.modname = "PLL2_ammo_box_545x39_US";
    ...
    load()
    {
        const itemId = "PLL2_ammo_box_545x39_US"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.45x39mm US ammo pack (180 pcs)";
        const itemShortName = "US";
        const itemDescription = "A paper package of 5.45x39mm US cartridges, 180 pieces.";

        // offer
        const itemTrader = "54cb50c76803fa8b248b4571"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "590a3cd386f77436f20848cb"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PLL2_ammo_box_545x39_US",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PLL2_ammo_box_545x39_US = PLL2_ammo_box_545x39_US;
