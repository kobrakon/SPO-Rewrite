class PKLL2_ammo_box_57x28_SS197SR
{
    constructor()
    {
        this.modname = "PKLL2_ammo_box_57x28_SS197SR";
    ...
    load()
    {
        const itemId = "PKLL2_ammo_box_57x28_SS197SR"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.7x28mm SS197SR ammo pack (180 pcs)";
        const itemShortName = "SS197SR";
        const itemDescription = "A paper package of 5.7x28mm SS197SR, 180 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "57347d7224597744596b4e72"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL2_ammo_box_57x28_SS197SR",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL2_ammo_box_57x28_SS197SR = PKLL2_ammo_box_57x28_SS197SR;
