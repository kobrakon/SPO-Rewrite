class PKLL1_ammo_box_556x45M856
{
    constructor()
    {
        this.modname = "PKLL1_ammo_box_556x45M856";
    ...
    load()
    {
        const itemId = "PKLL1_ammo_box_556x45M856"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.56x45mm M856 ammo pack (120 pcs)";
        const itemShortName = "M856";
        const itemDescription = "A paper package of 5.56x45mm M856 cartridges, 120 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "5672cb124bdc2d1a0f8b4568"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL1_ammo_box_556x45M856",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL1_ammo_box_556x45M856 = PKLL1_ammo_box_556x45M856;
