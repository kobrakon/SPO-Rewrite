class PKLL3_ammo_box_300_B_AP
{
    constructor()
    {
        this.modname = "PKLL3_ammo_box_300_B_AP";
    ...
    load()
    {
        const itemId = "PKLL3_ammo_box_300_B_AP"; // unique item id, used in tarkov
        ...
        const itemLongName = ".300 Blackout AP ammo pack (120 pcs)";
        const itemShortName = "B AP";
        const itemDescription = "A paper package of .300 Blackout AP, 120 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "59fafb5d86f774067a6f2084"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL3_ammo_box_300_B_AP",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL3_ammo_box_300_B_AP = PKLL3_ammo_box_300_B_AP;
