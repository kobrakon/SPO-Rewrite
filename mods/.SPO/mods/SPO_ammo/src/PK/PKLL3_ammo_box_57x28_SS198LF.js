class PKLL3_ammo_box_57x28_SS198LF
{
    constructor()
    {
        this.modname = "PKLL3_ammo_box_57x28_SS198LF";
    ...
    load()
    {
        const itemId = "PKLL3_ammo_box_57x28_SS198LF"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.7x28mm SS198LF ammo pack (180 pcs)";
        const itemShortName = "SS198LF";
        const itemDescription = "A paper package of 5.7x28mm SS198LF, 180 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5d1c774f86f7746d6620f8db"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL3_ammo_box_57x28_SS198LF",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL3_ammo_box_57x28_SS198LF = PKLL3_ammo_box_57x28_SS198LF;
