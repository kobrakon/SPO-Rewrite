class PKLL4_ammo_box_556x45M855A1
{
    constructor()
    {
        this.modname = "PKLL4_ammo_box_556x45M855A1";
    ...
    load()
    {
        const itemId = "PKLL4_ammo_box_556x45M855A1"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.56x45mm M855A1 ammo pack (120 pcs)";
        const itemShortName = "M855A1";
        const itemDescription = "A paper package of 5.56x45mm M855A1 cartridges, 120 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5af0561e86f7745f5f3ad6ac"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL4_ammo_box_556x45M855A1",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL4_ammo_box_556x45M855A1 = PKLL4_ammo_box_556x45M855A1;
