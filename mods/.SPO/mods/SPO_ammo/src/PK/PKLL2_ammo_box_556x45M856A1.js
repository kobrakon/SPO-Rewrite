class PKLL2_ammo_box_556x45M856A1
{
    constructor()
    {
        this.modname = "PKLL2_ammo_box_556x45M856A1";
    ...
    load()
    {
        const itemId = "PKLL2_ammo_box_556x45M856A1"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.56x45mm M856A1 ammo pack (120 pcs)";
        const itemShortName = "M856A1";
        const itemDescription = "A paper package of 5.56x45mm M856A1 cartridges, 120 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "5673de654bdc2d180f8b456d"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL2_ammo_box_556x45M856A1",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL2_ammo_box_556x45M856A1 = PKLL2_ammo_box_556x45M856A1;
