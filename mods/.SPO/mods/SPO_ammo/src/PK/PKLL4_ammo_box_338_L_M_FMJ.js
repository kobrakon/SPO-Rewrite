class PKLL4_ammo_box_338_L_M_FMJ
{
    constructor()
    {
        this.modname = "PKLL4_ammo_box_338_L_M_FMJ";
    ...
    load()
    {
        const itemId = "PKLL4_ammo_box_338_L_M_FMJ"; // unique item id, used in tarkov
        ...
        const itemLongName = ".338 Lapua Magnum FMJ ammo pack (80 pcs)";
        const itemShortName = "FMJ";
        const itemDescription = "A paper package of .338 Lapua Magnum FMJ, 80 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL4_ammo_box_338_L_M_FMJ",
                  "_max_count": 80,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL4_ammo_box_338_L_M_FMJ = PKLL4_ammo_box_338_L_M_FMJ;
