class PKLL3_ammo_box_57x28_SS190
{
    constructor()
    {
        this.modname = "PKLL3_ammo_box_57x28_SS190";
    ...
    load()
    {
        const itemId = "PKLL3_ammo_box_57x28_SS190"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.7x28mm SS190 ammo pack (180 pcs)";
        const itemShortName = "SS190";
        const itemDescription = "A paper package of 5.7x28mm SS190, 180 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5d1b304286f774253763a528"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL3_ammo_box_57x28_SS190",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL3_ammo_box_57x28_SS190 = PKLL3_ammo_box_57x28_SS190;
