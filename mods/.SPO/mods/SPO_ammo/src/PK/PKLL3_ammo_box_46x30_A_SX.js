class PKLL3_ammo_box_46x30_A_SX
{
    constructor()
    {
        this.modname = "PKLL3_ammo_box_46x30_A_SX";
    ...
    load()
    {
        const itemId = "PKLL3_ammo_box_46x30_A_SX"; // unique item id, used in tarkov
        ...
        const itemLongName = "46x30mm Action SX ammo pack (180 pcs)";
        const itemShortName = "A SX";
        const itemDescription = "A paper package of 46x30mm Action SX, 180 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "544fb6cc4bdc2d34748b456e"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL3_ammo_box_46x30_A_SX",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL3_ammo_box_46x30_A_SX = PKLL3_ammo_box_46x30_A_SX;
