class PKLL2_ammo_box_45_lasermatch_FMJ
{
    constructor()
    {
        this.modname = "PKLL2_ammo_box_45_lasermatch_FMJ";
    ...
    load()
    {
        const itemId = "PKLL2_ammo_box_45_lasermatch_FMJ"; // unique item id, used in tarkov
        ...
        const itemLongName = ".45 ACP Lasermatch FMJ ammo pack (120 pcs)";
        const itemShortName = "FMJ";
        const itemDescription = "A paper package of .45 ACP MLasermtch FMJ cartridges, 120 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5734779624597737e04bf329"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL2_ammo_box_45_lasermatch_FMJ",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL2_ammo_box_45_lasermatch_FMJ = PKLL2_ammo_box_45_lasermatch_FMJ;
