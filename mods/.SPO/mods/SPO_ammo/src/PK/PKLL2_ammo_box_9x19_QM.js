class PKLL2_ammo_box_9x19_QM
{
    constructor()
    {
        this.modname = "PKLL2_ammo_box_9x19_QM";
    ...
    load()
    {
        const itemId = "PKLL2_ammo_box_9x19_QM"; // unique item id, used in tarkov
        ...
        const itemLongName = "9x19mm QuakeMaker ammo pack (180 pcs)";
        const itemShortName = "QM";
        const itemDescription = "A paper package of 9x19mm QuakeMaker, 180 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL2_ammo_box_9x19_QM",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL2_ammo_box_9x19_QM = PKLL2_ammo_box_9x19_QM;
