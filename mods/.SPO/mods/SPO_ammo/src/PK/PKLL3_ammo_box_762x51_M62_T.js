class PKLL3_ammo_box_762x51_M62_T
{
    constructor()
    {
        this.modname = "PKLL3_ammo_box_762x51_M62_T";
    ...
    load()
    {
        const itemId = "PKLL3_ammo_box_762x51_M62_T"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x51mm M62 Tracer ammo pack (120 pcs)";
        const itemShortName = "M62 T";
        const itemDescription = "A paper package of 7.62x51mm M62 Tracer, 120 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "590a373286f774287540368b"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL3_ammo_box_762x51_M62_T",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL3_ammo_box_762x51_M62_T = PKLL3_ammo_box_762x51_M62_T;
