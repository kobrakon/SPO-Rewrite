class PKLL4_ammo_box_762x51_M61
{
    constructor()
    {
        this.modname = "PKLL4_ammo_box_762x51_M61";
    ...
    load()
    {
        const itemId = "PKLL4_ammo_box_762x51_M61"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x51mm M61 ammo pack (120 pcs)";
        const itemShortName = "M61";
        const itemDescription = "A paper package of 7.62x51mm M61, 120 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5d403f9186f7743cac3f229b"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL4_ammo_box_762x51_M61",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL4_ammo_box_762x51_M61 = PKLL4_ammo_box_762x51_M61;
