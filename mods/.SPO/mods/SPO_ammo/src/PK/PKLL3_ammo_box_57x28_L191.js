class PKLL3_ammo_box_57x28_L191
{
    constructor()
    {
        this.modname = "PKLL3_ammo_box_57x28_L191";
    ...
    load()
    {
        const itemId = "PKLL3_ammo_box_57x28_L191"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.7x28mm L191 ammo pack (180 pcs)";
        const itemShortName = "L191";
        const itemDescription = "A paper package of 5.7x28mm L191, 180 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 2;
        const itemTraderCurrency = "5d1c819a86f774771b0acd6c"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL3_ammo_box_57x28_L191",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL3_ammo_box_57x28_L191 = PKLL3_ammo_box_57x28_L191;
