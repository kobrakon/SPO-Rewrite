class PKLL3_ammo_box_45_ACP_AP
{
    constructor()
    {
        this.modname = "PKLL3_ammo_box_45_ACP_AP";
    ...
    load()
    {
        const itemId = "PKLL3_ammo_box_45_ACP_AP"; // unique item id, used in tarkov
        ...
        const itemLongName = ".45 ACP AP ammo pack (180 pcs)";
        const itemShortName = "AP";
        const itemDescription = "A paper package of .45 ACP ACP cartridges, 180 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5e2aedd986f7746d404f3aa4"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL3_ammo_box_45_ACP_AP",
                  "_max_count": 180,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL3_ammo_box_45_ACP_AP = PKLL3_ammo_box_45_ACP_AP;
