class PKLL2_ammo_box_556x45MK255M0
{
    constructor()
    {
        this.modname = "PKLL2_ammo_box_556x45MK255M0";
    ...
    load()
    {
        const itemId = "PKLL2_ammo_box_556x45MK255M0"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.56x45mm MK255 Mod 0 ammo pack (120 pcs)";
        const itemShortName = "MMK255M0";
        const itemDescription = "A paper package of 5.56x45mm MK255 Mod 0 cartridges, 120 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "5734781f24597737e04bf32a"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL2_ammo_box_556x45MK255M0",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL2_ammo_box_556x45MK255M0 = PKLL2_ammo_box_556x45MK255M0;
