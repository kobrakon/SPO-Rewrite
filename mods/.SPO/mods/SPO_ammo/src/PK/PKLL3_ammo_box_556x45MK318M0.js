class PKLL3_ammo_box_556x45MK318M0
{
    constructor()
    {
        this.modname = "PKLL3_ammo_box_556x45MK318M0";
    ...
    load()
    {
        const itemId = "PKLL3_ammo_box_556x45MK318M0"; // unique item id, used in tarkov
        ...
        const itemLongName = "5.56x45mm MK318 Mod 0 ammo pack (120 pcs)";
        const itemShortName = "MK318";
        const itemDescription = "A paper package of 5.56x45mm MK318 Mod 0 cartridges, 120 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL3_ammo_box_556x45MK318M0",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL3_ammo_box_556x45MK318M0 = PKLL3_ammo_box_556x45MK318M0;
