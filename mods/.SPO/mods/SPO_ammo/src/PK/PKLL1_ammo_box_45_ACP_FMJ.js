class PKLL1_ammo_box_45_ACP_FMJ
{
    constructor()
    {
        this.modname = "PKLL1_ammo_box_45_ACP_FMJ";
    ...
    load()
    {
        const itemId = "PKLL1_ammo_box_45_ACP_FMJ"; // unique item id, used in tarkov
        ...
        const itemLongName = ".45 ACP Match FMJ ammo pack (120 pcs)";
        const itemShortName = "FMJ";
        const itemDescription = "A paper package of .45 ACP Match FMJ cartridges, 120 pieces.";

        // offer
        const itemTrader = "5935c25fb3acc3127c3d8cd9"; // Prapor
        const itemTraderPrice = 1;
        const itemTraderCurrency = "590a3b0486f7743954552bdb"; // RUB: 5449016a4bdc2d6f028b456f USD: 5696686a4bdc2da3298b456a EUR: 569668774bdc2da2298b4568
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL1_ammo_box_45_ACP_FMJ",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL1_ammo_box_45_ACP_FMJ = PKLL1_ammo_box_45_ACP_FMJ;
