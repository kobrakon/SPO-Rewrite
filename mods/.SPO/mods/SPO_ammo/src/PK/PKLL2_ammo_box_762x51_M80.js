class PKLL2_ammo_box_762x51_M80
{
    constructor()
    {
        this.modname = "PKLL2_ammo_box_762x51_M80";
    ...
    load()
    {
        const itemId = "PKLL2_ammo_box_762x51_M80"; // unique item id, used in tarkov
        ...
        const itemLongName = "7.62x51mm M80 ammo pack (120 pcs)";
        const itemShortName = "M80";
        const itemDescription = "A paper package of 7.62x51mm M80, 120 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL2_ammo_box_762x51_M80",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL2_ammo_box_762x51_M80 = PKLL2_ammo_box_762x51_M80;
