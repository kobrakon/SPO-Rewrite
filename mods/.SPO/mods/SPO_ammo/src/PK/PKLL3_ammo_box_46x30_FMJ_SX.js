class PKLL3_ammo_box_46x30_FMJ_SX
{
    constructor()
    {
        this.modname = "PKLL3_ammo_box_46x30_FMJ_SX";
    ...
    load()
    {
        const itemId = "PKLL3_ammo_box_46x30_FMJ_SX"; // unique item id, used in tarkov
        ...
        const itemLongName = "46x30mm FMJ SX ammo pack (180 pcs)";
        const itemShortName = "SX";
        const itemDescription = "A paper package of 46x30mm FMJ SX, 180 pieces.";
    ...
    createItem(i_clone, i_id, i_path)
    {
        ...
        item._props.StackSlots =      
            [{
                  ...
                  "_parent": "PKLL3_ammo_box_46x30_FMJ_SX",
                  "_max_count": 120,
                  "_props": {
                    "filters": [
                      {
...
module.exports.PKLL3_ammo_box_46x30_FMJ_SX = PKLL3_ammo_box_46x30_FMJ_SX;
